    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iron', models.FloatField(default=0.0, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='철분(mg)')),
                ('updated_date', models.DateTimeField(auto_now=True, verbose_name='업데이트 날짜')),
                ('morning_diet', models.ImageField(blank=True, null=True, upload_to='images/daily/morning/%Y/%m/%d', verbose_name='아침 식단')),
                ('lunch_diet', models.ImageField(blank=True, null=True, upload_to='images/daily/lunch/%Y/%m/%d', verbose_name='점심 식단')),
                ('dinner_diet', models.ImageField(blank=True, null=True, upload_to='images/daily/dinner/%Y/%m/%d', verbose_name='저녁 식단')),
                ('snack_diet', models.ImageField(blank=True, null=True, upload_to='images/daily/snack/%Y/%m/%d', verbose_name='간식 식단')),
                ('target_date', models.DateField(null=True, verbose_name='일자')),
